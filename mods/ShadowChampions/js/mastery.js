...
function main() {
  if (m1 && m1 <= 10 && m1 >= 1) {
    ...
    document.getElementById("mastery1").src = document.getElementById("mastery1").src.replace("MasteryPage", "mods/ShadowChampions");
  }
  ...
  if (m2 && m2 <= 10 && m2 >= 1) {
    ...
    document.getElementById("mastery2").src = document.getElementById("mastery2").src.replace("MasteryPage", "mods/ShadowChampions");
  }
}
