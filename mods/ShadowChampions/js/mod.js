...
function main() {
  document.getElementById("name").innerText = "ShadowChampions";
  for (var i = 1; i < 11; i++) {
    ...
    document.getElementById(i.toString()).innerHTML = document.getElementById(i.toString()).innerHTML.replace("MasteryPage", "mods/ShadowChampions");
  }
}
